    ...
    protected void bootstrapBlockStateModels(WoverBlockModelGenerators generator) {
        this.addFromRegistry(
                ...
                ModelOverides.create()
                             ...
                             .override(EndBlocks.TENANEA_OUTER_LEAVES, generator::createFlatItem)
                             ...
                             .override(EndBlocks.MOSSY_GLOWSHROOM.getBark(), generator::delegateItemModel)
                             .override(EndBlocks.MOSSY_GLOWSHROOM.getLog(), generator::delegateItemModel)
                             .override(EndBlocks.MOSSY_GLOWSHROOM.getStrippedBark(), generator::delegateItemModel)
                             .override(EndBlocks.MOSSY_GLOWSHROOM.getStrippedLog(), generator::delegateItemModel)
