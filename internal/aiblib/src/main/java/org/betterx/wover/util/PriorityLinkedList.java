...
public class PriorityLinkedList<T> implements Iterable<T>, Collection<T> {
     ...
     * @throws ArrayStoreException  вЂ“ if the runtime type of any element in this collection is not assignable to the runtime component type of the specified array
     * @throws NullPointerException вЂ“ if the specified array is null
     */
    @NotNull
    @Override
