package org.aiblib.wover.feature.api.placed;

import org.aiblib.wover.block.api.predicate.IsFullShape;
import org.aiblib.wover.feature.api.configured.configurators.FeatureConfigurator;
import org.aiblib.wover.feature.api.configured.configurators.RandomPatch;
import org.aiblib.wover.feature.api.placed.modifiers.EveryLayer;
import org.aiblib.wover.feature.api.placed.modifiers.ExtendXYZ;
import org.aiblib.wover.feature.impl.placed.FeaturePlacementBuilderImpl;
 ...
 * {@link org.aiblib.wover.feature.api.configured.configurators.FeatureConfigurator}
...
public interface FeaturePlacementBuilder {
     ...
     * @see org.aiblib.wover.feature.api.placed.modifiers.NoiseFilter
     */
     ...
     * is determined by {@link org.aiblib.wover.block.api.predicate.BlockPredicates#ONLY_GROUND},
     * which basically checks if the block has the {@link org.aiblib.wover.tag.api.predefined.CommonBlockTags#TERRAIN}
     * tag.
     * <p>
     ...
     *                      {@link org.aiblib.wover.feature.api.placed.modifiers.ExtendXYZ.HeightPropagation} for
     *                      Details.
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block below matches the {@link org.aiblib.wover.block.api.predicate.BlockPredicates#ONLY_NYLIUM}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block below matches the {@link org.aiblib.wover.block.api.predicate.BlockPredicates#ONLY_NETHER_GROUND}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block above matches the {@link org.aiblib.wover.block.api.predicate.BlockPredicates#ONLY_NYLIUM}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block above matches the {@link org.aiblib.wover.block.api.predicate.BlockPredicates#ONLY_NETHER_GROUND}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
     ...
     * {@link org.aiblib.wover.feature.api.configured.configurators.AsSequence}).
     *
