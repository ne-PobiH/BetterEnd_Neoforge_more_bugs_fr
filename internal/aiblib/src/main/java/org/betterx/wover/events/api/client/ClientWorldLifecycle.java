package org.aiblib.wover.events.api.client;
...
import org.aiblib.wover.events.impl.client.ClientWorldLifecycleImpl;
...
public class ClientWorldLifecycle {
     ...
     * <p>
     * This is a variat of
     * a {@link org.aiblib.wover.events.api.ChainableSubscriber}.
     ...
     * <p>
     * This is a {@link org.aiblib.wover.events.api.ChainableSubscriber}, where the result of a subscriber is
