...
import org.aiblib.wover.datagen.api.provider.WoverStructurePoolProvider;
import org.aiblib.wover.datagen.api.provider.WoverStructureProcessorProvider;
import org.aiblib.wover.datagen.api.provider.WoverStructureSetProvider;
...
public abstract class WoverStructureProvider implements WoverMultiProvider {
    ...
    public void registerAllProviders(PackBuilder pack) {
        pack.addRegistryProvider(modCore ->
                new org.aiblib.wover.datagen.api.provider.WoverStructureProvider(modCore) {
                    @Override
