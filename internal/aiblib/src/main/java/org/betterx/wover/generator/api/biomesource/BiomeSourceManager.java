...
public class BiomeSourceManager {
     ...
     * {@link org.aiblib.wover.generator.impl.biomesource.nether.WoverNetherBiomeSource} for example
     * includes all biomes that have the {@code minecraft:is_nether} tag. The
     * {@link org.aiblib.wover.generator.impl.biomesource.end.WoverEndBiomeSource} includes all biomes
