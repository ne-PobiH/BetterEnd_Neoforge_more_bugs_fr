...
import org.aiblib.wover.surface.impl.numeric.NetherNoiseCondition;
import org.aiblib.wover.surface.impl.numeric.RandomIntProvider;
...
public class NumericProviders {
    ...
    /**
     * A Numeric sequence based on {@link org.aiblib.wover.surface.api.Conditions#NETHER_VOLUME_NOISE}.
     ...
     * {@link org.aiblib.wover.surface.api.Conditions#NETHER_VOLUME_NOISE}.
     * <p>
     * You can use this numeric provider in a .json file like this:
     * <pre class="json"> {
