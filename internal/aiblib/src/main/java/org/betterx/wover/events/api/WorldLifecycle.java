...
import org.aiblib.wover.events.api.types.*;
...
public class WorldLifecycle {
     ...
     * {@link org.aiblib.wover.events.api.types.OnRegistryReady.Stage} value that is sent along to
     * subscribers. Only a registry flagged with
     * {@link org.aiblib.wover.events.api.types.OnRegistryReady.Stage#FINAL} is the one that is used
     * in the actual world.
     * <p>
