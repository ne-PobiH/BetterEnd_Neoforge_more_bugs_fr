package org.aiblib.wover.generator.impl.map.square;

import org.aiblib.wover.generator.api.biomesource.WoverBiomePicker;
import org.aiblib.wover.generator.api.map.BiomeChunk;
import org.aiblib.wover.generator.api.map.BiomeMap;
import org.aiblib.wover.math.api.MathHelper;
...
public class SquareBiomeMap implements BiomeMap {
    private static final int MAX_CACHED_CHUNKS = 64;
    ...
    public void clearCache() {
        if (maps.size() >= MAX_CACHED_CHUNKS) {
            maps.clear();
        }
    }
