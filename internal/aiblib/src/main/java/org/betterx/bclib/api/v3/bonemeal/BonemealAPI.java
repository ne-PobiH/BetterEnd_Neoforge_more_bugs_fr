package org.aiblib.bclib.api.v3.bonemeal;
...
public class BonemealAPI {
    ...
    public boolean runSpreaders(ItemStack itemStack, Level level, BlockPos blockPos, boolean forceBonemeal) {
        ...
        BonemealBlockSpreader spreader = org.aiblib.bclib.api.v3.bonemeal.BonemealAPI
                .INSTANCE
        ...
        FeatureSpreader fSpreader = org.aiblib.bclib.api.v3.bonemeal.BonemealAPI
                .INSTANCE
