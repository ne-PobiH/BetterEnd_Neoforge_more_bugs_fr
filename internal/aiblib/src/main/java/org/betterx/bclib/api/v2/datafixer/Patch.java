package org.aiblib.bclib.api.v2.datafixer;

import org.aiblib.wunderlib.utils.Version;
import org.aiblib.bclib.interfaces.PatchBiFunction;
import org.aiblib.bclib.interfaces.PatchFunction;
...
public abstract class Patch {
     ...
     * {@link org.aiblib.wover.state.api.WorldConfig} for this Mod.
     * The function needs to return {@code true}, if changes were made to the data.
     * If an error occurs, the method should throw a {@link PatchDidiFailException}
     * <p>
     * The default implementation of this method returns null.
    ...
    /**
     * Returns a list of paths where your mod stores IDs in your {@link org.aiblib.wover.state.api.WorldConfig}-File.
     * <p>
     ...
     *
     * @return {@code null} if nothing changes or a list of Paths in your {@link org.aiblib.wover.state.api.WorldConfig}-File.
     * Paths are dot-seperated (see {@link org.aiblib.wover.state.api.WorldConfig#getCompoundTag(ModCore, String)}).
     */
